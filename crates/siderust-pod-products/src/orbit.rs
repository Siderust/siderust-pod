...
use siderust_pod_core::spacecraft::SpacecraftState;
use siderust_pod_io::oem::{write_oem, OemMetadata, OemState};
use siderust_pod_io::sp3::{write_sp3, EarthCenter, Sp3Epoch, Sp3Position, Sp3Record};
...
///
/// ```
/// use siderust_pod_products::orbit::write_sp3_from_states;
        ...
        .map(|s| {
            ...
            Sp3Epoch {
                ...
                positions: vec![Sp3Position {
                    ...
                    // where EarthCenter is siderust_pod_io::sp3::EarthCenter (Params = ()).
...
///
/// ```
/// use siderust_pod_products::orbit::write_oem_from_states;
/// use siderust::astro::dynamics::{OrbitState, Position, Velocity};
/// use siderust::coordinates::frames::GCRS;
/// use siderust::time::JulianDate;
///
...
///
/// ```
/// use siderust_pod_products::orbit::write_oem_from_spacecraft_states;
/// use siderust_pod_core::spacecraft::SpacecraftState;
...
///
/// ```
/// use siderust_pod_products::orbit::Sp3ProductWriter;
///
...
///
/// ```
/// use siderust_pod_products::orbit::OemProductWriter;
///
