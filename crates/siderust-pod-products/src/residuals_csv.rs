...
///
/// ```
/// use siderust_pod_products::residuals_csv::{ResidualRow, write_residuals_csv};
///
...
///
/// ```
/// use siderust_pod_products::residuals_csv::ResidualRecord;
///
...
///
/// ```
/// use siderust_pod_products::residuals_csv::{ResidualCsvWriter, ResidualRecord};
///
...
impl<W: Write> ResidualCsvWriter<W> {
    ...
    ///
    /// ```
    /// use siderust_pod_products::residuals_csv::ResidualCsvWriter;
    ///
    /// let mut buf = Vec::<u8>::new();
