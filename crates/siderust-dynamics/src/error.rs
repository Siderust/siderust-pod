...
use crate::thrust::ManeuverError;
...
///
/// ```
/// use siderust_dynamics::{DynamicsError, ManeuverError};
///
/// fn check(isp: f64) -> Result<(), DynamicsError> {
///     siderust_dynamics::mass_flow_rate(qtty_core::units::force::Newtons::new(1.0), isp)?;
///     Ok(())
/// }
