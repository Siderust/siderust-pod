...
//!   [`siderust_pod_core::providers::EphemerisProvider`] via **cubic Hermite**
...
use crate::{oem::read_oem, PodIoError};
use affn::cartesian;
...
///
/// ```
/// use siderust_pod_io::lisa::HeliocentricCenter;
...
///
/// ```
/// use siderust_pod_io::lisa::LisaSpacecraftId;
...
///
/// ```
/// use siderust_pod_io::lisa::{LisaOrbitReader, LisaSpacecraftId};
///
/// let oem = "\
/// CCSDS_OEM_VERS = 2.0\n\
...
///
/// ```
/// use siderust_pod_io::lisa::{LisaOrbitReader, LisaOrbitSet, LisaSpacecraftId};
///
...
///
/// ```
/// use siderust_pod_io::lisa::{LisaOrbitReader, LisaOrbitSet, LisaEphemerisProvider, LisaSpacecraftId};
/// use siderust_pod_core::providers::EphemerisProvider;
///
/// let root = concat!(env!("CARGO_MANIFEST_DIR"), "/test-data/lisa");
/// let load = |name: &str, sc: LisaSpacecraftId| {
...
///
/// ```
/// use siderust_pod_io::lisa::LisaProviderError;
