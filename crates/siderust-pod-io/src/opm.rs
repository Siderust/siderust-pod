...
///
/// ```
/// use siderust_pod_io::opm::CartesianState;
...
///
/// ```
/// use siderust_pod_io::opm::KeplerianElements;
...
///
/// ```
/// use siderust_pod_io::opm::OpmMetadata;
/// let m = OpmMetadata {
...
///
/// ```
/// use siderust_pod_io::opm::{OpmMessage, OpmMetadata, CartesianState};
/// let msg = OpmMessage {
...
///
/// ```
/// use siderust_pod_io::opm::read_opm;
///
...
///
/// ```
/// use siderust_pod_io::opm::{write_opm, read_opm, OpmMessage, OpmMetadata, CartesianState};
///
/// let msg = OpmMessage {
///     metadata: OpmMetadata {
///         object_name: "SAT".to_string(),
