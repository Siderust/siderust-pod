...
//!
//! Delegates KVN and XML parsing/writing to [`siderust_tle::omm::kvn`] and
//! [`siderust_tle::omm::xml`], exposing them under the unified
...
use siderust_tle::omm::{kvn, xml};
use std::io::{Read, Write};

/// Re-export of the `siderust-tle` OMM record.
///
/// See [`siderust_tle::omm::Omm`] for field documentation.
///
/// # Examples
///
/// ```
/// use siderust_pod_io::omm::OmmMessage;
/// use siderust_tle::{parse_3le, omm::Omm};
...
/// ```
pub use siderust_tle::omm::Omm as OmmMessage;
...
///
/// ```
/// use siderust_pod_io::omm::read_omm_kvn;
///
...
///
/// ```
/// use siderust_pod_io::omm::{write_omm_kvn, OmmMessage};
/// use siderust_tle::{parse_3le, omm::Omm};
///
/// let l1 = "1 25544U 98067A   08264.51782528 -.00002182  00000-0 -11606-4 0  2927";
/// let l2 = "2 25544  51.6416 247.4627 0006703 130.5360 325.0288 15.72125391563537";
...
///
/// ```
/// use siderust_pod_io::omm::{read_omm_xml, write_omm_xml, OmmMessage};
/// use siderust_tle::{parse_3le, omm::Omm};
///
/// let l1 = "1 25544U 98067A   08264.51782528 -.00002182  00000-0 -11606-4 0  2927";
/// let l2 = "2 25544  51.6416 247.4627 0006703 130.5360 325.0288 15.72125391563537";
...
///
/// ```
/// use siderust_pod_io::omm::{write_omm_xml, OmmMessage};
/// use siderust_tle::{parse_3le, omm::Omm};
///
/// let l1 = "1 25544U 98067A   08264.51782528 -.00002182  00000-0 -11606-4 0  2927";
/// let l2 = "2 25544  51.6416 247.4627 0006703 130.5360 325.0288 15.72125391563537";
