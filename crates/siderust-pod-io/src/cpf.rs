...
///
/// ```
/// use siderust_pod_io::cpf::GeocentricCenter;
...
///
/// ```
/// use siderust_pod_io::cpf::{parse_cpf, GeocentricCenter};
/// use affn::centers::ReferenceCenter;
///
...
///
/// ```
/// use siderust_pod_io::cpf::{parse_cpf, CpfEphemeris};
///
...
///
/// ```no_run
/// use siderust_pod_io::cpf::read_cpf;
...
///
/// ```
/// use siderust_pod_io::{ParseMode, cpf::parse_cpf_with_mode};
/// let txt = "H1 CPF 2 HTS 2024 01 01 00 1\nH2 s 0 0\n10 1 BROKEN\n99\n";
...
///
/// ```
/// use siderust_pod_io::cpf::{parse_cpf, write_cpf};
///
/// let txt = "H1 CPF 2 CNES 2024 01 01 00 1\n\
///            H2 lageos1 1155 7603901 2024 1 1 0 0 0 2024 1 1 1 0 0 60 0 ITRF2014\n\
