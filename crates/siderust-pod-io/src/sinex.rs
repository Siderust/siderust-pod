...
///
/// ```
/// use siderust_pod_io::sinex::GeoCenterItrf;
...
///
/// ```
/// use siderust_pod_io::sinex::SinexPosition;
...
///
/// ```
/// use siderust_pod_io::sinex::{StationCoordinate, SinexPosition};
...
///
/// ```
/// use siderust_pod_io::sinex::SinexSolution;
