...
mod inner {
    ...
    use crate::obs_trait::{CartesianState, ObsType, Observation};
    use crate::provider_bundle::ProviderBundle;
    use siderust::time::JulianDate;
    use siderust_pod_core::providers::EphemerisProvider;
    use siderust_pod_io::lisa::{LisaEphemerisProvider, LisaSpacecraftId};
    use std::sync::Arc;
    ...
    ///
    /// ```no_run
    /// use siderust_pod_observations::inter_sat::InterSatRangeObs;
    ...
    /// use siderust_pod_io::lisa::{LisaEphemerisProvider, LisaOrbitReader, LisaOrbitSet, LisaSpacecraftId};
