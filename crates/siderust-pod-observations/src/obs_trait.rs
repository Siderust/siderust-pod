...
///
/// ```
/// use siderust_pod_observations::obs_trait::CartesianState;
...
///
/// ```
/// use siderust_pod_observations::obs_trait::ObsType;
...
///
/// ```
/// use siderust_pod_observations::obs_trait::PhaseResidual;
///
...
///
/// ```
/// use siderust_pod_observations::obs_trait::{ObsResidual, PhaseResidual};
///
...
///
/// ```
/// use siderust_pod_observations::obs_trait::{CartesianState, Observation, ObsType};
...
///         _providers: &dyn siderust_pod_observations::provider_bundle::ProviderBundle,
...
///
/// ```
/// use siderust_pod_observations::obs_trait::{AnyObservation, ObsResidual};
