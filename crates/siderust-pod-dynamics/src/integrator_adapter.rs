...
//!
//! Re-exports of [`siderust_dynamics::Integrator`] (and the concrete
...
use siderust_dynamics::Integrator;
...
/// the upstream `siderust_dynamics::thrust` module, not this adapter.
///
/// # Example
///
/// ```
/// use siderust_pod_dynamics::{propagate_spacecraft, Rk4Integrator};
/// use siderust::astro::dynamics::forces::TwoBody;
...
mod tests {
    ...
    use siderust::coordinates::frames::GCRS;
    use siderust::time::JulianDate;
    use siderust_dynamics::Rk4Integrator;
