...
use crate::parse::compute_tle_checksum;
...
///
/// ```
/// use siderust_tle::{Classification, InternationalDesignator, SatelliteNumber, TleBuilder};
/// use qtty::angular::Degrees;
/// use qtty_core::units::{angular::Turn, angular_rate::AngularRate, time::Day};
/// use tempoch::{Time, UTC};
...
impl TleBuilder {
    ...
    ///
    /// ```
    /// use siderust_tle::{SatelliteNumber, TleBuilder};
    ...
    ///
    /// ```
    /// use siderust_tle::{Classification, TleBuilder};
    ...
    ///
    /// ```
    /// use siderust_tle::{InternationalDesignator, TleBuilder};
    /// let _b = TleBuilder::new()
    ///     .international_designator(InternationalDesignator("98067A".into()));
    /// ```
    ...
    ///
    /// ```
    /// use siderust_tle::{TleBuilder, TleError};
...
///
/// ```
/// use siderust_tle::{format_tle, parse_tle};
